        ...
        <?php else : ?>
            ...
            <div id="tour_card" class="card small blue-grey lighten-1">
                ...
                <div id="tour_action" class="card-action">
                    <a id="tour_skip_btn" class="waves-effect waves-green btn-flat modal_left_button">Skip</a>
                    <a id="tour_next_btn" class="waves-effect waves-green btn-flat modal_right_button">Next</a>
                    <a id="tour_prev_btn" class="waves-effect waves-green btn-flat modal_right_button">Prev</a>
                </div>
